const Button = ({
  ...
  let buttonClass =
    type === "primary"
      ...
      : type === "secondary"
      ? "border border-gray-300 from-gray-300 to-gray-100 hover:from-gray-50 hover:to-gray-100 text-gray-900"
      : type === "tertiary"
  ...
  return (
    <div
      className={`bg-gradient-to-tr text-center rounded-sm shadow-md transition duration-500 cursor-pointer ${buttonClass} ${buttonSize} ${buttonClassName}`}
    >
