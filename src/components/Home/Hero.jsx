...
const Hero = () => {
  ...
  return (
    <section className="h-[calc(100vh-64px)] max-w-[1920px] mt-12 sm:mt-16 mx-auto px-4 md:px-6 lg:px-12 xl:px-24 py-10 flex flex-col md:flex-row md:justify-between items-center md:gap-10 lg:gap-20 overflow-hidden">
      {/* Hero Content */}
