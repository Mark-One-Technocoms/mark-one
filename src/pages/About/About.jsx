...
const About = () => {
  return (
    <main className="">
      {/* Hero / Intro */}
      <section className="max-w-[1920px] mx-auto px-4 md:px-6 lg:px-12 xl:px-24 py-20 flex flex-col md:flex-row justify-between items-center gap-10">
        {/* Left Content */}
      ...
      {/* Mission & Vision */}
      <section className="py-20 bg-gray-50 max-w-[1920px] mx-auto px-4 md:px-6 lg:px-12 xl:px-24">
